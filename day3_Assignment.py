...
label_6 =Label(root,text="Father Name", width=10,font=("bold",10))
label_6.place(x=72,y=230)
...
Checkbutton(root,text="Accept Terms and Condition", variable=var1).place(x=72,y=380)


#this creates button for submitting the details provides by the user
Button(root, text='Submit' , width=20,bg="black",fg='white',font=("bold",10)).place(x=70,y=430)
